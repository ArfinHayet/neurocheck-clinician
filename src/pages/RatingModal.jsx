  ...
  return (
    ...
    >
      <p className="text-xs text-[#3C3C4399] -mt-7">
        The summary is generated by AI based on the patient's assessment.
        There might be some inconsistency. Your review can help us make it
        better in future.
      </p>
      ...
      <form onSubmit={handleSubmit} className="mt-6">
        ...
        <button
          type="submit"
          className="mt-4 w-full rounded-full bg-[#0A4863] text-white py-2 font-medium hover:opacity-95 active:opacity-90"
        >
          Submit this review
        </button>
      </form>
