...
// const AdditionalInfoModal = ({ isModalOpen, closeModal, patientId }) => {
//   const [medName, setMedName] = useState("");
//   const [meds, setMeds] = useState([]);

//   // Add medication/question
//   const addMedication = () => {
//     if (!medName.trim()) return;
...
//     const formattedString = meds
//       .map((med, index) => `question-${index + 1}: ${med.name}`)
//       .join(", ");

//     const obj = {
//       additionalInfo: formattedString,
//     };
...
//       if (result) {
//         setMeds([]); // clear state after success
//         setMedName("");
//         closeModal();
//       }
//     } catch (error) {
...
//             {/* Input */}
//             <input
//               className="w-full bg-white border border-[#E1E1E1] rounded-2xl p-2 text-sm outline-none"
//               placeholder="Write your question here"
//               value={medName}
//               onChange={(e) => setMedName(e.target.value)}
//               onKeyDown={(e) => e.key === "Enter" && addMedication()} // allow Enter key
//             />
//             <div className="flex justify-end -mt-[35px] mr-1">
//               <button
//                 type="button"
